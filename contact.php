                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">Adajan Road Bhulka Bhavan School</span> <br>
										<span class="text-white">Pal Road Bhagban Circle</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-white">+91 8141808254</span>
										<span class="text-white">+91 8141807377</span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-white">priyanshu.jariwala001@gmail.com</span>
										<span class="text-white">priyanshu.jariwala001@gmail.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
