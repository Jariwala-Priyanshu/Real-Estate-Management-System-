...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('images/banner/3.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Selling services involves offering your expertise, time, or resources to fulfill a particular need or solve a problem for your clients.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Rental services involve providing temporary access to goods or property in exchange for a fee.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Property listing involves creating detailed descriptions and advertisements for properties that are available for sale or rent.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Legal investment involves making financial investments in compliance with applicable laws and regulations..</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>When seeking top-rated information, it often depends on the context or topic you're interested in..</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>"Experience quality" typically refers to the level of satisfaction or enjoyment derived from a particular experience.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>An experienced agent is someone who has a wealth of knowledge, skills, and expertise in a particular field or industry</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Discussion is a process of exchanging ideas, opinions, and information between two or more people with the goal of reaching a deeper understanding of a topic, resolving a problem, or making a decision..</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>File review involves examining documents, records, or data to assess their content, accuracy, completeness, and compliance with relevant standards or requirements. </p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>It generally means to obtain or gain possession of something. In various contexts, "acquire" can refer to different processes or actions..</p>
                        </div>
                    </div>
                </div>
            </div>
